...
Thanks for reading,
Zachary, CRO-THEHACKER, DarkTroi - Dev'''
...
\____/\___/|_| |_|\__|_|  |_|_.__/|___/
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/DarkTroi/fsocietyIPhone.git")
...
class setoolkit:
    ...
    def install(self):
        os.system("apk add git apache2 python-requests libapache2-mod-php \
...
class reaver:
    ...
    def install(self):
        os.system("git clone --depth=1 %s %s" %
                  (self.gitRepo, self.installDir))
        os.system(
            "apk add build-essential libpcap-dev sqlite3 libsqlite3-dev aircrack-ng pixiewps")
...
class pixiewps:
    ...
    def install(self):
        os.system("git clone --depth=1 %s %s" %
                  (self.gitRepo, self.installDir))
        os.system("apk add build-essential")
        os.system("make")
        os.system("sudo make install")
...
class bluepot:
    ...
    def install(self):
        os.system("apk add libbluetooth-dev")
        os.system(
...
def insinurl():
    ...
    os.system("apk add curl libcurl3 libcurl3-dev php5 php5-cli php5-curl")
...
def ssls():
    ...
    if yesOrNo():
        ...
        os.system("apk add python-twisted-web")
